...
QtVariantEditorFactoryPrivate::~QtVariantEditorFactoryPrivate()
{
    if(m_spinBoxFactory) {
    ...
    if(m_timeEditFactory) {
        delete m_dateEditFactory;
    }

    if(m_dateTimeEditFactory) {
        delete m_dateTimeEditFactory;
    }

    if(m_keySequenceEditorFactory) {
        delete m_keySequenceEditorFactory;
    }

    if(m_charEditorFactory) {
        delete m_charEditorFactory;
    }

    if(m_comboBoxFactory) {
    ...
    if(m_cursorEditorFactory) {
        delete m_cursorEditorFactory;
    }

    if(m_colorEditorFactory) {
        delete m_colorEditorFactory;
    }

    if(m_fontEditorFactory) {
        delete m_fontEditorFactory;
    }
}
