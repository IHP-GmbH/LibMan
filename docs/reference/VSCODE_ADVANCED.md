...
1. Copy a build task in `.vscode/tasks.json`
...
1. Run any task
2. Check the "Terminal" panel (`Ctrl+J`)
...
2. **Restore from docs**: See reference in this folder
...
- **Setup**: [VS Code Setup](../setup/VSCODE_SETUP.md)
- **Reference**: [Quick Reference Card](QUICK_REFERENCE.md)
