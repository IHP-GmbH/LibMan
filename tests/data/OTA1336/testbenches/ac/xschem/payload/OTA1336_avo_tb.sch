...
N 220 -230 220 -180 {lab=GND}
N 240 -180 260 -180 {lab=GND}
N 260 -240 260 -180 {lab=GND}
N 130 -560 130 -290 {lab=vm}
N 130 -290 220 -290 {lab=vm}
...
B 2 1680 -1350 2480 -950 {flags=graph y1=-21 y2=30 ypos1=0 ypos2=2 divy=5 subdivy=1 unity=1 x1=0 divx=5 subdivx=8 xlabmag=1.0 ylabmag=1.0 dataset=-1 unitx=1 logx=1 logy=0 x2=7 color=4 node="psrr_linear}
B 2 880 -1750 1680 -1350 {flags=graph y1=-8.7 y2=71 ypos1=0 ypos2=2 divy=5 subdivy=1 unity=1 x1=0 divx=5 subdivx=8 xlabmag=1.0 ylabmag=1.0 dataset=-1 unitx=1 logx=1 logy=0 x2=7 sim_type=ac hilight_wave=0 color="6 node="\\"vout}
B 2 1680 -1750 2480 -1350 {flags=graph y1=21 y2=67 ypos1=0 ypos2=2 divy=5 subdivy=1 unity=1 x1=0 divx=5 subdivx=8 xlabmag=1.0 ylabmag=1.0 dataset=-1 unitx=1 logx=1 logy=0 x2=7 color=4 node=cmrr}
B 2 880 -1350 1680 -950 {flags=graph ypos1=0 ypos2=2 divy=5 subdivy=4 unity=1 x1=0 divx=5 subdivx=8 xlabmag=1.0 ylabmag=1.0 dataset=-1 unitx=1 logx=1 logy=0 autoload=0 sim_type=ac y2=-0.042 y1=-160 color="4 node=ph(vout) x2=7}
...
C {capa.sym} 450 -560 0 0 {name=Cload m=1 value=500f footprint=1206 device="ceramic}
...
C {devices/code_shown.sym} 20 -1610 0 0 {name=NGSPICE only_toplevel=false value=" = = = =}
...
C {vcvs.sym} 220 -260 0 1 {name=E1 value=1}
C {gnd.sym} 240 -160 0 0 {name=l6 lab=GND}
