...
N 680 -630 700 -630 {lab=vm}
N 840 -730 840 -700 {lab=vdd}
N 460 -960 460 -940 {lab=GND}
N 80 -1050 80 -1020 {lab=vp}
N 840 -620 840 -600 {lab=GND}
N 190 -940 460 -940 {lab=GND}
N 1020 -600 1020 -590 {lab=GND}
N 190 -940 190 -920 {lab=GND}
N 1080 -660 1080 -350 {lab=vm}
N 460 -1050 460 -1020 {lab=vdd}
N 700 -350 1080 -350 {lab=vm}
N 80 -940 190 -940 {lab=GND}
N 800 -470 800 -460 {lab=GND}
N 680 -690 750 -690 {lab=vp}
N 80 -960 80 -940 {lab=GND}
N 800 -600 800 -530 {lab=#net1}
N 700 -630 750 -630 {lab=vm}
B 2 860 -1380 1660 -980 {flags=graph y1=0.1 y2=1.1 ypos1=0 ypos2=2 divy=5 subdivy=1 unity=1 x1=0 divx=5 subdivx=4 xlabmag=1.0 ylabmag=1.0 dataset=-1 unitx=1 logx=0 logy=0 x2=0.0002 color="4 node="vp}
C {vsource.sym} 80 -990 0 0 {name=V1 value="DC}
C {vsource.sym} 460 -990 0 0 {name=VDD value="DC}
...
C {capa.sym} 1020 -630 0 0 {name=Cload m=1 value=500f footprint=1206 device="ceramic}
...
C {devices/code_shown.sym} 10 -1640 0 0 {name=NGSPICE only_toplevel=false value="}
