...
F {}
E {}
T {adjust the timing of the source according your needs} 1200 -650 0 0 0.4 0.4 {}
...
tran 1n 2u
meas tran Vmax MAX v(out) from=750n to=1.5u
let ovshoot = $&vmax/0.65
echo $&ovshoot > CACE\{simpath\}/CACE\{filename\}_CACE\{N\}.data
*quit
.endc
"}
C {devices/vsource.sym} 820 -700 0 0 {name=Vsig value="pulse(0 50m 0 100p 100p 500n 1u)" savecurrent=false}
