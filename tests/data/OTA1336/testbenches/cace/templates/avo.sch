...
N 870 -1080 870 -680 {
lab=inp}
N 870 -1080 1450 -1080 {
lab=inp}
N 750 -1170 750 -680 {
lab=vdd}
N 750 -1170 1570 -1170 {
lab=vdd}
N 1200 -910 1200 -680 {
lab=vss}
N 1200 -910 1570 -910 {
...
C {devices/vsource.sym} 1200 -650 0 0 {name=Vvss value="DC CACE\{Vvss\}" savecurrent=false}
...
C {devices/res.sym} 1840 -1010 0 0 {name=Rout
value=CACE\{Rout\}
device=resistor}
C {devices/capa.sym} 1980 -1010 0 0 {name=Cout
value=CACE\{Cout\}}
C {devices/lab_pin.sym} 2020 -980 0 1 {name=p27 sig_type=std_logic lab=VSUB}
C {devices/vsource.sym} 750 -650 0 0 {name=Vvdd value="DC CACE\{Vvdd\}" savecurrent=false}
...
echo $&vres > CACE\{simpath\}/CACE\{filename\}_CACE\{N\}.data
quit
.endc
"}
C {devices/res.sym} 1050 -590 0 0 {name=RSUB
value=0.01
device=resistor}
...
C {isource.sym} 1020 -650 0 0 {name=Ibias value="DC CACE\{Ibias\}"}
...
.option warn=1
"}
C {title-3.sym} 0 0 0 0 {name=l2 author="IHP-GmbH 2026" title="CACE testbench AV0" rev=1.0 lock=true}
C {vsource.sym} 870 -650 0 0 {name=V1 value="DC CACE\{Vcm\} AC 1 0"
}
C {ind.sym} 1550 -840 1 0 {name=L6
m=1
value=4G
footprint=1206
device=inductor}
C {capa.sym} 1450 -810 0 0 {name=C1
m=1
value=4G
footprint=1206
